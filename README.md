...
#DONE: история транскрибаций сохраняется в подменю «📋 История текста» (до 20 записей, с persistence через NSUserDefaults)
#TODO: сделать переключатель чтобы некоторые запросы не сохранялись в историю
#TODO: сохранять аудиозаписи в историю и сделать ротацию 

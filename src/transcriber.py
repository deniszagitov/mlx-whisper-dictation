...
class SpeechTranscriber:
    ...
    def transcribe_for_llm(self, audio_data, language=None, *, llm_processor, system_prompt):
        ...
        clipboard_context = self._read_clipboard()
        ...
        notify_user("🤖 LLM", llm_response[:LLM_NOTIFICATION_CHAR_LIMIT])

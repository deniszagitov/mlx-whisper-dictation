...
RUNTIME_TARGETS = (
    ...
    ModuleTarget("Reader source", ROOT / "src/use_cases/reader_source.py", "api/modules/reader_source.md"),
    ModuleTarget("Reader preprocessing", ROOT / "src/use_cases/preprocess_text.py", "api/modules/reader_preprocessing.md"),
...
def _render_index(runtime_modules: list[ModuleDoc], setup_module: ModuleDoc) -> str:
    ...
    lines = [
        ...
        "",
        (
            "Для описания входных и выходных данных используется правильный термин "

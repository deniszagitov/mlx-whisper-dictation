...
- `_ZIPPER_SPEAK_TEXT_CONTRACT` = `'Передавай только готовую фразу для озвучивания: обычные слова буквами, числа словами, без цифр, markdown, URL, кода, JSON и технических идентификаторов. Для длинного или технического текста используй show_text или output_mode: window.'`
